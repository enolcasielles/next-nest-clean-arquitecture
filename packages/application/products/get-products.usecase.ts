...
import { type Either, CustomError, makeLeft, makeRight } from '../../domain/errors'
...
export class GetProductsUseCase implements UseCase<Request, Context, PaginatedResponse<ProductEntity>> {
  async execute (context: Context, request: Request): Promise<Either<CustomError, PaginatedResponse<ProductEntity>>> {
    try {
