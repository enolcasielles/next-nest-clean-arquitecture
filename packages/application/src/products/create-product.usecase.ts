import { z } from 'zod'
import { type IProductsRepository, type CreateProductRequest, type ProductEntity, type Either, makeLeft, makeRight, CustomError, ProductCategory } from '@marketplace/domain'
